...
E -> "1" [0.04]  | "2" [0.03]  | "3" [0.01]  | "4" [0.01]  | "5" [0.01]
E -> "sin("E")" [0.04] | "cos("E")" [0.04] | "tan("E")" [0.02]
E -> "exp("E")" [0.05] | "log("E")" [0.05] | "sqrt("E")" [0.03]
E -> "asin("E")" [0.02] | "atan("E")" [0.02]
E -> "sinh("E")" [0.01] | "cosh("E")" [0.01] | "tanh("E")" [0.01]
E -> "-("E")" [0.02]
E -> "("E"+"E")" [0.03] | "("E"-"E")" [0.03] | "("E"*"E")" [0.06]
E -> "("E"/"E")" [0.07] | "("E"**"E")" [0.04]
"""
